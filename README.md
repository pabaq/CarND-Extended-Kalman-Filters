...
## Using sensor fusion to track a moving object
...
the parts that need to be integrated into the C++ code of the Kalman filter.
...
- No sensor is 100% precise. The sensors uncertainty is represented by the measurement
  noise ***w***.
